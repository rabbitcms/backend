...
@section('content')
    <div class="portlet box blue-hoki ajax-portlet" data-require="rabbitcms.backend.users:form">
        <div class="portlet-title">
            <div class="caption">
                {{$model->exists ? trans('backend::common.edit_user') : trans('backend::common.create_user')}}</div>
            <div class="actions">
                <a class="btn btn-default btn-sm" rel="back" href="{{relative_route('backend.backend.users.index')}}">
            ...
            <form id="users-form" method="post" class="form" data-type="{{$model->exists ? 'update' : 'create'}}"
                ...
                <div class="form-actions">
                    <div class="pull-right">
                        <a class="btn red" rel="back" href="{{relative_route('backend.backend.users.index')}}">
