...
<head>
    ...
    <link href="{{asset_module('backend/plugins/font-awesome/css/font-awesome.min.css', 'backend')}}" rel="stylesheet" type="text/css">
    <link href="{{asset_module('backend/plugins/simple-line-icons/simple-line-icons.min.css', 'backend')}}" rel="stylesheet" type="text/css">
    <link href="{{asset_module('backend/plugins/jquery-ui/jquery-ui.custom.min.css', 'backend')}}" rel="stylesheet" type="text/css">
    <link href="{{asset_module('backend/plugins/bootstrap/css/bootstrap.min.css', 'backend')}}" rel="stylesheet" type="text/css">
